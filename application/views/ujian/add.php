        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    <h4>Program Studi <i class="fa fa-book pull-right"></i></h4>
                    <p><?=$matkul->nama_kelas?></p>
                </div>
                <div class="alert bg-purple">
            ...
            <div class="col-sm-4">
                ...
                <input type="hidden" name="matkul_id" value="<?=$matkul->id_kelas;?>">
                <div class="form-group">
                    <label for="jenis">Nama Ujian</label>
                ...
                <input type="hidden" name="jenis" value="acak">
