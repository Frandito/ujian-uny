                        ...
                        <tr>
                            ...
                            <td width="230">
                                <div class="form-group">
                                    ...
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$row->nama_matkul?>" type="text" name="nama_matkul[<?=$no?>]" class="form-control">
                            ...
                            <td width="170">
                                <div class="form-group">
                                    <select required="required" name="jenis_nilai[<?=$i?>]" class="form-control input-sm select2" style="width: 100%!important">
                                        <option value="" disabled>-- Pilih --</option>
                                        <?php foreach ($metode as $m) : ?>
                                            <option <?= $row->jenis_nilai == $m->id_m ? "selected='selected'" : "" ?> value="<?=$m->id_m?>"><?=$m->nama_nilai?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <small class="help-block text-right"></small>
                                </div>
