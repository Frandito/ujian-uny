...
<div class="row">
    <div class="col-sm-12">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="dosen_id" class="control-label">Dosen (Bidang Studi)</label>
                                <input type="hidden" name="nilai_id" value="<?=$id_tes->jenis_nilai;?>">
                                ...
                                <select required="required" name="dosen_id" id="dosen_id" class="select2 form-group" style="width:100% !important">
                                    ...
                                    foreach ($dosen as $d) :
                                        ...
                                        <option <?=$sdm===$dm?"selected":"";?> value="<?=$dm?>"><?=$d->nama_dosen?> (<?=$d->nama_kelas?>)</option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="help-block" style="color: #dc3545"><?=form_error('dosen_id')?></small>
                                <?php else : ?>
                                <input type="hidden" name="dosen_id" value="<?=$dosen->id_dosen;?>">
                                <input type="hidden" name="matkul_id" value="<?=$id_tes->id_matkul;?>">
        ...
        <?=form_close();?>
    <?php else : ?>
        <?=form_open_multipart('soal/savepoli', array('id'=>'formsoal'), array('method'=>'edit', 'id_soal'=>$soal->id_soal));?>
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?=$subjudul?></h3>
                <div class="box-tools pull-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        <label for="bobot">Bobot Jawaban <?= $ABJ; ?></label>
                                        <input value="<?=$soal->$bobot;?>" type="number" name="nilai_<?= $abj; ?>" id="nilai_<?= $abj; ?>" placeholder="Bobot Jawaban <?= $abj; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
