...
class KelasDosen extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Program Studi - Dosen',
			'subjudul'=> 'Data Program Studi - Dosen'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Program Studi - Dosen',
			'subjudul'	=> 'Tambah Data Program Studi - Dosen',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Program Studi - Dosen',
			'subjudul'		=> 'Edit Data Program Studi - Dosen',
