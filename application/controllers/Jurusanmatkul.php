...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Bidang Keilmuan - Jenis Tes',
			'subjudul'=> 'Bidang Keilmuan - Jenis Tes'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Bidang Keilmuan - Jenis Tes',
			'subjudul'	=> 'Tambah Data Bidang Keilmuan - Jenis Tes',
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Bidang Keilmuan - Jenis Tes',
			'subjudul'		=> 'Edit Bidang Keilmuan - Jenis Tes',
